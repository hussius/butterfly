...
printTopGOresults <- function(topGOdata,outName){
  ...
  resultFis <- getSigGroups(GOdata_BP, test.statFis)
  ...
  resultKS <- getSigGroups(GOdata_BP, test.statKS)
  ...
  resultElim <- getSigGroups(GOdata_BP, test.statElim)
  
  test.statWei <- new("weightCount", testStatistic=GOFisherTest, name="Fisher test", sigRatio="ratio")
  resultWei <- getSigGroups(GOdata_BP, test.statWei)
  ...
  allRes <- GenTable(GOdata_BP, classicFisher = resultFis, classicKS = resultKS, elimFisher = resultElim, WeightedFisher = resultWei, orderBy="WeightedFisher", ranksOf="classicFisher", topNodes=30)
  
  allResadj <- GenTable(GOdata_BP, classicFisheradj = resultFisadj, classicKSadj = resultKSadj, elimFisher = resultElim, WeightedFisher = resultWei, orderBy="WeightedFisher", ranksOf="classicFisheradj", topNodes=30)
  ...
  showSigOfNodes(GOdata_BP, score(resultFisadj), firstSigNodes=15, useInfo="all")
  dev.off()
  ...
  showSigOfNodes(GOdata_BP, score(resultFis), firstSigNodes=15, useInfo="all")
  dev.off()
  ...
  showSigOfNodes(GOdata_BP, score(resultWei), firstSigNodes=15, useInfo="all")
  dev.off()
